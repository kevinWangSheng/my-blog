...
- content:check: passed, `pnpm --dir site content:check -- --input ../docs/content-pipeline/manifests/coding-agent-eval-needs-isolation`
- content:sync: passed, wrote `site/src/content/essays/coding-agent-eval-needs-isolation.md`
- build: passed, `pnpm --dir site build`; generated `/essays/coding-agent-eval-needs-isolation/index.html`
- preview URL: local static preview prepared at `/my-blog/essays/coding-agent-eval-needs-isolation/` under `out/ui-serve`
